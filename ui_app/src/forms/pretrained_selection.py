...
from ui_app.src.forms.training_config_selection import (
    configure_algo,
    create_new_training_config,
)
from ui_app.src.trainings_source.file_based import (
    FileSysteModelsSource,
    WeightsAndConfigs,
)
...
def configure_pretained() -> Optional[
    ...
    training_config = create_new_training_config(algo, model_config)
